...
<img src="./res/grp_alert.png" alt="grp_alert">
                        ...
                        <article>
                            ...
                            <div class="chart_box">
                                ...
                                <div class="chart_view c5">
                                    ...
                                    <div class="chart_wrap">
                                        <h4>팬상태</h4>
                                        <img src="./res/fan_trend.png" alt="fan_trend">
                                    </div>
                                    <div class="chart_wrap">
                                        <h4>포트 상태</h4>
    ...
    def generate_plot(self, df, filename):
        ...
        plt.xticks(df['date'].values, fontsize=5)
    ...
    def horizontal_bar(self, df, filename):
        ...
        fig, ax = plt.subplots(figsize=(4.3, 1.6))
    ...
    def vertical_bar(self, df, filename):
        ...
        fig, ax = plt.subplots(figsize=(3.05, 1.65))

        ax.spines['right'].set_visible(False)
        ax.spines['top'].set_visible(False)
        plt.bar(x, values, width=0.25, color='#1bc0e1')
        plt.xticks(x, obj, fontsize=10)
        plt.savefig(filename, dpi=100, bbox_inches='tight')
        plt.show()
